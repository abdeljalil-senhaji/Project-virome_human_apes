...
#SBATCH -o /shared/projects/virome_human_apes/virome_analysis/gorilla_data/slurm_gorilla_data_metaspades.%N.%j.out
#SBATCH -e /shared/projects/virome_human_apes/virome_analysis/gorilla_data/slurm_gorilla_data_metaspades.%N.%j.err
