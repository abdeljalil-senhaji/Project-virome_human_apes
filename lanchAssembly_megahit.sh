...
#SBATCH --job-name=incompl_megahit
#SBATCH --cpus-per-task=28
#SBATCH --mem=250GB
#SBATCH --time=1-00:00:00
#SBATCH --partition=fast
#SBATCH -o /shared/projects/virome_human_apes/virome_analysis/data_incompl/slurm_hum_data_megahit.%N.%j.out
#SBATCH -e /shared/projects/virome_human_apes/virome_analysis/data_incompl/slurm_hum_data_megahit.%N.%j.err
