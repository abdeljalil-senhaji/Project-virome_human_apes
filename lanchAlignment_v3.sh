...
#SBATCH -o /shared/projects/virome_human_apes/virome_analysis/ech_hum/new_slurm_blastN_gori.%N.%j.out
#SBATCH -e /shared/projects/virome_human_apes/virome_analysis/ech_hum/new_slurm_blastN_gori.%N.%j.err
...
do
  ...
  do
   ...
   then
     ...
     bwa mem -t 14 ${refGenome}/Homo_sapiens.GRCh38.dna.primary_assembly.fa ${R1fastQgzFile} ${R2fastQgzFile} | samtools view -@ 10 -b -o ${bam}
