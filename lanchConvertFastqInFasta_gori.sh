...
#SBATCH --job-name=gori_cov
#SBATCH --cpus-per-task=20
#SBATCH --mem=20GB
#SBATCH --time=1-00:00:00  ## 3 j
#SBATCH --partition=fast
#SBATCH -o /shared/projects/virome_human_apes/virome_analysis/gorilla_data/slurm_convert_cat_chimp.%N.%j.out
#SBATCH -e /shared/projects/virome_human_apes/virome_analysis/gorilla_data/slurm_convert_cat_chimp.%N.%j.err
