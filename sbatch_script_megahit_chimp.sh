...
#SBATCH --job-name=chimp_megahit
#SBATCH --cpus-per-task=28
#SBATCH --mem=150GB
#SBATCH --time=1-00:00:00
#SBATCH --partition=fast
#SBATCH -o /shared/projects/virome_human_apes/virome_analysis/chimb_data/AAA_slurm_chimb_data_megahit.%N.%j.out
#SBATCH -e /shared/projects/virome_human_apes/virome_analysis/chimb_data/AAA_slurm_chimb_data_megahit.%N.%j.err
 ...
 do
  ...
  if [ -f "${R2fastQgzFile}" ];
   then
    ...
    srun megahit -t 24 --out-prefix ${prefix} --min-contig-len 500 -1 ${R1fastQgzFile} -2 ${R2fastQgzFile} -o ${contigFasta}
